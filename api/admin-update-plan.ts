...
const PLAN_DEFAULTS: Record<string, Record<string, string>> = {
  pro_monthly: { plan: 'pro', billing_cycle: 'monthly', saves_limit: '300',       boards_limit: '30',        file_size_limit: '20MB', storage_limit: '2GB',  status: 'active', source: 'admin' },
  pro_yearly:  { plan: 'pro', billing_cycle: 'yearly',  saves_limit: '300',       boards_limit: '30',        file_size_limit: '20MB', storage_limit: '2GB',  status: 'active', source: 'admin' },
  team:        { plan: 'team', billing_cycle: 'monthly', saves_limit: 'unlimited', boards_limit: 'unlimited', file_size_limit: '50MB', storage_limit: '10GB', status: 'active', source: 'admin' },
};
