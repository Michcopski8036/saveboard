export const translations = {
  en: {
    ...
    // Card
    myNote: 'MY NOTE', article: 'Article', minRead: 'min read',
    // Modals
    editContent: 'Edit Content', title: 'Title', description: 'Description', contentLabel: 'Content',
    ...
    freePlan: 'Free plan', proPlan: 'Pro plan', teamPlan: 'Team plan',
  ...
  ko: {
    ...
    myNote: '내 메모', article: '아티클', minRead: '분 읽기',
    editContent: '내용 편집', title: '제목', description: '설명', contentLabel: '내용',
    ...
    freePlan: '무료 플랜', proPlan: 'Pro 플랜', teamPlan: 'Team 플랜',
  ...
  ja: {
    ...
    myNote: 'メモ', article: '記事', minRead: '分',
    editContent: 'コンテンツを編集', title: 'タイトル', description: '説明', contentLabel: '内容',
    ...
    freePlan: '無料プラン', proPlan: 'Proプラン', teamPlan: 'Teamプラン',
  ...
  zh: {
    ...
    myNote: '我的笔记', article: '文章', minRead: '分钟',
    editContent: '编辑内容', title: '标题', description: '描述', contentLabel: '内容',
    ...
    freePlan: '免费计划', proPlan: 'Pro计划', teamPlan: 'Team计划',
  ...
  es: {
    ...
    myNote: 'MI NOTA', article: 'Artículo', minRead: 'min',
    editContent: 'Editar contenido', title: 'Título', description: 'Descripción', contentLabel: 'Contenido',
    ...
    freePlan: 'Plan gratuito', proPlan: 'Plan Pro', teamPlan: 'Plan Team',
  ...
  fr: {
    ...
    myNote: 'MA NOTE', article: 'Article', minRead: 'min',
    editContent: 'Modifier le contenu', title: 'Titre', description: 'Description', contentLabel: 'Contenu',
    ...
    freePlan: 'Plan gratuit', proPlan: 'Plan Pro', teamPlan: 'Plan Team',
