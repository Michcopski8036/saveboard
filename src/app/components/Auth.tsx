      ...
      <div className="w-full max-w-sm" style={{ marginTop: inApp ? '110px' : 0 }}>
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-3 bg-black text-white rounded-[10px] hover:bg-gray-900 transition-colors"
          >
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-3 border border-gray-200 rounded-[10px] hover:bg-gray-50 transition-colors"
          >
